...
uses
  ...
  U_pesq_contas_receber in '..\Forms\U_pesq_contas_receber.pas' {Frm_Pesq_contas_receber},
  U_movimenta_preco in '..\Forms\U_movimenta_preco.pas' {Frm_movimenta_preco},
  U_padrao_backup in '..\Forms\U_padrao_backup.pas' {Frm_padrao_backup},
...
begin
  ...
  Application.CreateForm(TFrm_Pesq_contas_receber, Frm_Pesq_contas_receber);
  Application.CreateForm(TFrm_movimenta_preco, Frm_movimenta_preco);
  Application.CreateForm(TFrm_padrao_backup, Frm_padrao_backup);
  Application.CreateForm(TFrm_backup, Frm_backup);
  Application.CreateForm(TFrm_Restore, Frm_Restore);
  Application.Run;
end.
