...
begin
  case cb_chave_pesquisa.ItemIndex of
    0:begin
      ...
      lb_texto.Caption := 'Digite o Código:';
      ED_Nome.Clear;
    end;
    1:begin
      ED_Nome.Visible := True;
      ...
      lb_texto.Visible := true;
      lb_inicio.Visible := false;
      lb_texto.Caption := 'Digite o Nome do Usuário:';
      ED_Nome.Clear;
    end;
    2:begin
      ED_Nome.Visible := True;
      ...
      lb_texto.Visible := true;
      lb_inicio.Visible := false;
      lb_texto.Caption := 'Digite o Código do Fornecedor:';
      ED_Nome.Clear;
    end;
    3:begin
      ED_Nome.Visible := True;
      ...
      lb_texto.Visible := true;
      lb_inicio.Visible := false;
      lb_texto.Caption := 'Digite o Código da Forma de Pgto:';
      ED_Nome.Clear;
    end;
    4:begin
