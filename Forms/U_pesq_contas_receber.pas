...
procedure TFrm_Pesq_contas_receber.bt_ImprimirClick(Sender: TObject);
var caminho : string;
begin
  caminho := ExtractFilepath(Application.ExeName);
  if Frm_Pesq_contas_receber.Rel_Pesq_Padrao.LoadFromFile(caminho + 'Rel_lista_receber.fr3') then
  begin
