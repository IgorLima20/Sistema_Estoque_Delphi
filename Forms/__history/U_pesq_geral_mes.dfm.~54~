object Frm_pesq_geral_mes: TFrm_pesq_geral_mes
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'PESQUISAS GERAL POR PER'#205'ODO'
  ClientHeight = 461
  ClientWidth = 844
  Color = clBtnFace
  ...
  object q_compra: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  FROM COMPRA A'
      '  WHERE A.CADASTRO between :pdata_ini AND :pdata_fim'
      
        '  group BY extract(MONTH FROM A.CADASTRO),  extract(YEAR FROM A.' +
        'CADASTRO)'
    ...
    object q_compraMES: TSmallintField
    ...
    object q_compraANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
    ...
    object q_compraVALOR_COMPRA: TFMTBCDField
      AutoGenerateValue = arDefault
  ...
  object q_venda: TFDQuery
    ...
    object q_vendaMES: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object q_vendaANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
    ...
    object q_vendaVALOR_VENDA: TFMTBCDField
      AutoGenerateValue = arDefault
  ...
  object q_conta_pagar: TFDQuery
    ...
    SQL.Strings = (
      ...
      '  WHERE A.DT_PAGAMENTO between :pdata_ini AND :pdata_fim'
        ...
        '  group BY extract(MONTH FROM A.DT_PAGAMENTO),  extract(YEAR FRO' +
        'M A.DT_PAGAMENTO)'
    ...
    object q_conta_pagarMES: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object q_conta_pagarANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
  ...
  object q_conta_receber: TFDQuery
    ...
    object q_conta_receberMES: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object q_conta_receberANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
    ...
    object q_conta_receberTOTAL_RECEBIDO: TFMTBCDField
      AutoGenerateValue = arDefault
  ...
  object q_conta_a_pagar: TFDQuery
    Connection = DM.Conexao
    SQL.Strings = (
      'select'
    ...
    object q_conta_a_pagarMES: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object q_conta_a_pagarANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
    ...
    object q_conta_a_pagarVALOR_A_PAGAR: TFMTBCDField
      AutoGenerateValue = arDefault
  ...
  object q_conta_a_receber: TFDQuery
    Connection = DM.Conexao
    SQL.Strings = (
      'select'
      '  extract(MONTH FROM A.DT_VENCIMENTO) AS MES,'
    ...
    object q_conta_a_receberMES: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object q_conta_a_receberANO: TSmallintField
      AutoGenerateValue = arDefault
      FieldName = 'ANO'
      Origin = 'ANO'
      ProviderFlags = []
    ...
    object q_conta_a_receberVALOR_A_RECEBER: TFMTBCDField
      AutoGenerateValue = arDefault
  ...
  object ds_conta_a_pagar: TDataSource
    DataSet = q_conta_a_pagar
    Left = 632
    Top = 248
  end
  object ds_conta_a_receber: TDataSource
    DataSet = q_conta_a_receber
    Left = 360
    Top = 272
  end
  object Rel_Geral: TfrxReport
    Version = '2022.2.8'
    ...
    ReportOptions.CreateDate = 43985.752263240700000000
    ReportOptions.LastChange = 44785.649175520830000000
    ...
    Datasets = <
      item
        DataSet = frx_conta_a_receber
        DataSetName = 'frx_conta_a_receber'
      end
      item
        DataSet = frx_conta__a_pagar
        DataSetName = 'frx_conta__a_pagar'
      end>
    Variables = <
      item
        Name = ' Periodo'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE CONTAS QUE FALTAM SER PAGAS'
            'E DE CONTAS QUE FALTAM SER RECEBIDAS POR PER'#205'ODO')
          ParentFont = False
        end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Dados de contas que Faltam Pagar')
          ParentFont = False
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frx_conta__a_pagar'
        RowCount = 0
        object frx_Contas_Pagar_a_pagarMES: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frx_conta__a_pagar."MES"]')
          ParentFont = False
        end
        object frx_Contas_Pagar_a_pagarANO: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frx_conta__a_pagar."ANO"]')
          ParentFont = False
        end
        object frx_Contas_Pagar_a_pagarVALOR_A_PAGAR: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frx_conta__a_pagar."VALOR_A_PAGAR"]')
          ParentFont = False
        end
      end
      object MasterData2: TfrxMasterData
        ...
        DataSetName = 'frx_conta_a_receber'
        RowCount = 0
        object frx_Contas_Receber_a_receberMES: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          Width = 79.370130000000000000
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frx_conta_a_receber."MES"]')
          ParentFont = False
        end
        object frx_Contas_Receber_a_receberANO: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          Left = 79.370130000000000000
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frx_conta_a_receber."ANO"]')
          ParentFont = False
        end
        object frx_Contas_Receber_a_receberVALOR_A_RECEBER: TfrxMemoView
          IndexTag = 1
          Align = baWidth
          AllowVectorExport = True
          Left = 158.740260000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frx_conta_a_receber."VALOR_A_RECEBER"]')
          ParentFont = False
        end
      end
      ...
      object Header1: TfrxHeader
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Dados de Contas que Faltam Receber')
          ParentFont = False
        end
  ...
  object frx_compra: TfrxDBDataset
    UserName = 'frx_compra'
  ...
  object frx_conta_a_receber: TfrxDBDataset
    UserName = 'frx_conta_a_receber'
    CloseDataSource = False
    DataSet = q_conta_a_receber
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object frx_venda: TfrxDBDataset
    UserName = 'frx_venda'
    CloseDataSource = False
    DataSet = q_venda
    BCDToCurrency = False
  ...
  object frx_conta_receber: TfrxDBDataset
    UserName = 'frx_conta_receber'
    CloseDataSource = False
    DataSet = q_conta_receber
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object frx_conta__a_pagar: TfrxDBDataset
    UserName = 'frx_conta__a_pagar'
    CloseDataSource = False
    DataSet = q_conta_a_pagar
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object frx_conta_pagar: TfrxDBDataset
    UserName = 'frx_conta_pagar'
    CloseDataSource = False
    DataSet = q_conta_pagar
    BCDToCurrency = False
    DataSetOptions = []
