...
begin
  try
    ...
    backup.Backup;
    Application.MessageBox('Backup realizado com sucesso!', 'Atenção', MB_OK+MB_ICONINFORMATION);
  except
    Application.MessageBox('Erro ao gerar backup!', 'Atenção', MB_OK+MB_ICONINFORMATION);
  end;
