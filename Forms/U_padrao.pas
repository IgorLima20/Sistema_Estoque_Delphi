...
begin
  try
    ...
    Application.MessageBox('Erro na gravação dos dados, verifique!', 'Atenção', MB_OK+MB_ICONINFORMATION);
  end;
end;
...
begin
  TrataBotoes;
  Q_padrao.Cancel;
  MessageDlg('Ação cancelado pelo usuário!', mtInformation, [mbOK], 0);
end;
