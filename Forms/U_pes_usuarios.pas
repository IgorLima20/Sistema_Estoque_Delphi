...
type
  TFrm_Pesq_Usuarios = class(TFrm_Pesquisa_Padrao)
...
var
  Frm_Pesq_Usuarios: TFrm_Pesq_Usuarios;

implementation

{$R *.dfm}

procedure TFrm_Pesq_Usuarios.bt_ImprimirClick(Sender: TObject);
var caminho : string;
begin
  caminho := ExtractFilepath(Application.ExeName);
  if Frm_Pesq_Usuarios.Rel_Pesq_Padrao.LoadFromFile(caminho + 'REL_USUARIOS.fr3') then
  begin
    Rel_Pesq_Padrao.clear;
    Rel_Pesq_Padrao.LoadFromFile(extractfilepath(application.ExeName) +  'REL_USUARIOS.fr3');
...
procedure TFrm_Pesq_Usuarios.bt_PesquisarClick(Sender: TObject);
begin
...
procedure TFrm_Pesq_Usuarios.bt_TransferirClick(Sender: TObject);
begin
...
procedure TFrm_Pesq_Usuarios.DBGrid1DblClick(Sender: TObject);
begin
  bt_Transferir.Click;
end;
