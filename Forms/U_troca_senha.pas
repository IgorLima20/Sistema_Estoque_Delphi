...
begin
  ...
  begin
    Application.MessageBox('O campo nome não pode ser vazio.', 'Atenção', MB_OK+MB_ICONINFORMATION);
    edt_Nome.SetFocus;
    Abort;
  end
  else
  ...
  begin
    Application.MessageBox('O campo de nova senha não pode ser vazio.', 'Atenção', MB_OK+MB_ICONINFORMATION);
  ...
  begin
    Application.MessageBox('O campo de confirmação senha não pode ser vazio.', 'Atenção', MB_OK+MB_ICONINFORMATION);
  ...
  begin
    Application.MessageBox('As senhas são diferentes!!', 'Atenção', MB_OK+MB_ICONINFORMATION);
    edt_confirma_senha.SetFocus;
    Abort;
  end;
  ...
  begin
    ...
    DM.Q_Login.Refresh;
    Application.MessageBox('Senha atualizada com sucesso', 'Atenção', MB_OK+MB_ICONINFORMATION);
    Frm_Troca_Senha.Close;
    Frm_Login.edt_Nome.SetFocus;
  end
  else
    Application.MessageBox('Nome ou senha incorretos, verifique', 'Atenção', MB_OK+MB_ICONINFORMATION);
    edt_Nome.SetFocus;
end;
