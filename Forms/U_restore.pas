...
begin
  try
    ...
    restore.Restore;
    Application.MessageBox('Restauração realizada com sucesso!', 'Atenção', MB_OK+MB_ICONINFORMATION);
  except
    Application.MessageBox('Erro ao Restaurar!', 'Atenção', MB_OK+MB_ICONINFORMATION);
  end;
end;
